...
donors_list = [
    ...
    "مريم", "قلق", "مهجد", "معطاب", "نور", "رانيا", "نينجا", "ابو ليلى لي أكلها الذئب", "الخديوي", "قطام"
]
prizes_list = [
    "سيارة فاخرة", "رحلة إلى الغابة", "جهاز آيفون 19", "جهاز لابتوب صيني", "هدايا بقيمة 1000 دولار",
    "جهاز تابلت", "كوبون شراء", "كأس ذهبي", "ساعة فاخرة", "رحلة سياحية إلى قرية ليلى",
    "هدايا مالية", "حقيبة من جاد الكوالا", "عندو كهربائي ", "رحلة إلى بيت جدة ليلى", "مقص فاخر",
    "برج الاسد", "حقيبة سفر", "ساعة ذكية", "بطاقة هدايا", "كعكة عيد "
]
